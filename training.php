...
if(isset($_POST['location']))
{
	...
	//echo "INSERT INTO Training_session VALUES (NULL,".$name.",".$id_user.",".$date.",".$type.",".$trainer.",".$location.",".$description.")";
	// die();
...
<form method="post" action="filter_training_date.php">
<div class="col-xs-3">
...
<form class="navbar-form" style="margin: 0; padding-right: 0;" method="post" action="search_training.php">
	...
	<div align=\"center\">
		<nav aria-label=\"Page navigation example\">
		  <ul class=\"pagination\">";
		    	...
		    	if ($page != 1) 
	    		{
	    			echo "<li class=\"page-item\"><a class=\"page-link\" href=\"training.php?page=".$prev_page."\">Previous</a></li>";
	    		}
		    	...
		    	{ 
		    		...
		    		echo"\"><a class=\"page-link\" href=\"training.php?page=".$i."\">".$i."</a></li>";
		    	}

		    	$next_page = $page + 1;
		    	if ($page != $nr_of_pages) 
	    		{
	    			echo "<li class=\"page-item\"><a class=\"page-link\" href=\"training.php?page=".$next_page."\">Next</a></li>";
	    		}
