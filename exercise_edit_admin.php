...
try 
{
	...
	{
		$result = $connection->query("SELECT * FROM Exercises WHERE ID = '$id_exercise' ");
		...
		$result = $connection->query("SELECT Name FROM Body_parts INNER JOIN Exercises_Body_parts ON Exercises_Body_parts.ID_Body_parts = Body_parts.ID WHERE ID_Exercises ='$id_exercise'");
...
<div class="panel-heading">
			   <div class="panel-title text-center">
			      <h1 class="title">Edit permanent exercise</h1>
			      <hr style="width: 20%;" />
			   </div>
			</div>
 <div class="container">
  	<div class="">
	    <div class = "center">
          ...
          <a href="exercises_admin.php">Back</a>
        </div>
	      </form>
	  </div>
  </div>
