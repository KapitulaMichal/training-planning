...
{ 
    ...
    window.location="delete_exercise_admin.php?id="+id;
    return false;
}
</script>
...
<div class="panel-heading">
   <div class="panel-title text-center">
      <h1 class="title">Permanent exercises</h1>
      <hr />
    </div>
</div>
...
<div class="row">
	...
	<div class="col-xs-6 text-right">
		<form class="navbar-form" style="margin: 0; padding-right: 0;" method="post" action="search_exercises_admin.php">
...
try 
{
	...
	else
	{
		...
		$nr_of_records = $permanent_exercises;
		...
		while ($row = $result->fetch_assoc())
		{
			...
			if($permanet == 1 )
			{
				if($i>($page-1)*$elements_on_page && $i<=($page-1)*$elements_on_page+$elements_on_page)
				{
					...
					echo "</td>
					<td>";
					echo '<a href="exercise_edit_admin.php?id_exercise='. $id .'" class="btn btn-info">Edit</a>
					   <a  class="btn btn-danger" onclick= " delete_exercise(\''. $id.'\') " >Delete</a>';
	...
	<div align=\"center\">
		<nav aria-label=\"Page navigation example\">
		  <ul class=\"pagination\">";
		    	...
		    	if ($page != 1) 
	    		{
	    			echo "<li class=\"page-item\"><a class=\"page-link\" href=\"exercises_admin.php?page=".$prev_page."\">Previous</a></li>";
	    		}
		    	...
		    	{ 
		    		...
		    		echo"\"><a class=\"page-link\" href=\"exercises_admin.php?page=".$i."\">".$i."</a></li>";
		    	}

		    	$next_page = $page + 1;
		    	if ($page != $nr_of_pages) 
	    		{
	    			echo "<li class=\"page-item\"><a class=\"page-link\" href=\"exercises_admin.php?page=".$next_page."\">Next</a></li>";
	    		}
...
<div id="myModal" class="modal">
  	...
  	<div class="modal-content">
	    ...
	    <div class = "center" >
	      ...
	      <form class="form-horizontal" method="post" action="add_exercise_admin.php">
