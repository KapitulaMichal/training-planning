...
<div style="margin-bottom: 2px;">
	<span class="glyphicon glyphicon-search" aria-hidden="true"></span><strong> Date from: </strong> 
	<?php echo $date_from ?> <strong> to: </strong> 	<?php echo $date_to ?>
</div>
